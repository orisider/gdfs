...
import com.orisider.gdfs.ui.fragment.LoadingFragment;
...
public class GoogDriveOpen extends RoboSherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drive_open);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuItem shareItem = menu.add(Menu.NONE, MENU_ID_SHARE, 0, "Share");
        shareItem.setShowAsAction(MenuItem.SHOW_AS_ACTION_WITH_TEXT);
        return true;
    }
